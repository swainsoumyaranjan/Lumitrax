...
class MatrixEvent extends _typedEventEmitter.TypedEventEmitter {
   ...
   */
  isDecryptionFailure() {
    var _this$clearEvent;
    return ((_this$clearEvent = this.clearEvent) === null || _this$clearEvent === void 0 || (_this$clearEvent = _this$clearEvent.content) === null || _this$clearEvent === void 0 ? void 0 : _this$clearEvent.msgtype) === "m.bad.encrypted";
  }
