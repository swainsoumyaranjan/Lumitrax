...
class EventTimeline {
  ...
  static setEventMetadata(event, stateContext, toStartOfTimeline) {
    ...
    if (!((_event$target = event.target) !== null && _event$target !== void 0 && (_event$target = _event$target.events) !== null && _event$target !== void 0 && _event$target.member) && event.getType() === _event.EventType.RoomMember) {
