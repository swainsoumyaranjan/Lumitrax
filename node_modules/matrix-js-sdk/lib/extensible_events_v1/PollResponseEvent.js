...
class PollResponseEvent extends _ExtensibleEvent.ExtensibleEvent {
  ...
  constructor(wireFormat) {
    super(wireFormat);
    (0, _defineProperty2.default)(this, "internalAnswerIds", []);
    (0, _defineProperty2.default)(this, "internalSpoiled", false);
  ...
  validateAgainst(poll) {
    ...
    let answers = (_response$answers = response === null || response === void 0 ? void 0 : response.answers) !== null && _response$answers !== void 0 ? _response$answers : [];
