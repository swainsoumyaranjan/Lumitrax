...
import { ValidatedIssuerConfig, ValidatedIssuerMetadata } from "./oidc/validate";
...
export declare class AutoDiscovery {
     ...
     * @returns Config or failure result
     */
    static discoverAndValidateAuthenticationConfig(wellKnown: IClientWellKnown): Promise<(OidcClientConfig & AutoDiscoveryState) | AutoDiscoveryState>;
    /**
