...
class MatrixClient extends _typedEventEmitter.TypedEventEmitter {
  ...
  async initRustCrypto({
    ...
    const rustCrypto = await RustCrypto.initRustCrypto(this.logger, this.http, userId, deviceId, this.secretStorage, this.cryptoCallbacks, useIndexedDB ? _constants.RUST_SDK_STORE_PREFIX : null, this.pickleKey);
  ...
  async joinRoom(roomIdOrAlias, opts = {}) {
    ...
    if (room !== null && room !== void 0 && room.hasMembershipState(this.credentials.userId, "join")) return room;
    ...
    if (resolvedRoom !== null && resolvedRoom !== void 0 && resolvedRoom.hasMembershipState(this.credentials.userId, "join")) return resolvedRoom;
  ...
  knockRoom(roomIdOrAlias, opts = {}) {
    const room = this.getRoom(roomIdOrAlias);
    if (room !== null && room !== void 0 && room.hasMembershipState(this.credentials.userId, "knock")) {
  ...
  encryptAndSendEvent(room, event) {
    ...
    return Promise.resolve().then(() => {
      ...
      try {
        ...
        this.logger.error("Exception in error handler!", e.stack || err);
      }
  ...
  paginateEventTimeline(eventTimeline, opts) {
    ...
    if (isNotifTimeline) {
      ...
      promise = this.fetchRelations((_eventTimeline$getRoo2 = eventTimeline.getRoomId()) !== null && _eventTimeline$getRoo2 !== void 0 ? _eventTimeline$getRoo2 : "", thread.id, _thread.THREAD_RELATION_TYPE.name, null, {
        ...
        const mapper = this.getEventMapper();
        const matrixEvents = res.chunk.filter(_utils.noUnsafeEventProps).map(mapper);
