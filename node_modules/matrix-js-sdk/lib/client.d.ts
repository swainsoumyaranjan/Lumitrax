...
import { FileType, HttpApiEvent, HttpApiEventHandlerMap, IHttpOpts, IRequestOpts, TokenRefreshFunction, MatrixError, MatrixHttpApi, Upload, UploadOpts, UploadResponse } from "./http-api";
...
export declare class MatrixClient extends TypedEventEmitter<EmittedEvents, ClientEventHandlerMap> {
     ...
     * @returns Rejects: with an error response.
     */
    setPowerLevel(roomId: string, userId: string | string[], powerLevel: number | undefined, 
    /**
     * @deprecated no longer needed, unused.
     */
    event?: MatrixEvent | null): Promise<ISendEventResponse>;
    /**
     ...
     * @returns Rejects: with an error response.
     */
    sendStateEvent(roomId: string, eventType: string, content: IContent, stateKey?: string, opts?: IRequestOpts): Promise<ISendEventResponse>;
    /**
     * @returns Promise which resolves: TODO
     * @returns Rejects: with an error response.
     */
